import { Box, Input, VStack, Image, Flex, Text, Button } from "@chakra-ui/react"
    ...
    <>
      <Box border={"1px solid gray"} borderRadius={4} padding={5}>
        <VStack spacing={4}>
          ...
          {!isLogin ? <Input placeholder="Confirm Password" type="password" fontSize={14}  
      ...
      <Box border={"1xp solid gray"} borderRadius={4} padding={5}>
